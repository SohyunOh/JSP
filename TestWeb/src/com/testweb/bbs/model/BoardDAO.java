...
public class BoardDAO {
	...
	public void write(String writer,String title, String content) {
		String sql = "insert into testboard (bno,writer,title,content) values(tsetboard_seq.nextval,?,?,?)";
...
//글 수정
	...
	//유저리스트
		public ArrayList<BoardVO> UserList(int pageNum, int amount, String id) {
			...
			String sql = "SELECT * FROM (\r\n" + 
					...
					"from(SELECT b.* \r\n" + 
					"FROM testboard b\r\n" + 
					"INNER join testuser u on u.id = b.writer\r\n" + 
