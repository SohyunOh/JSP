                ...
                <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                    ...
                    <form action="joinFrom.user" method="post" name ="regForm">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control sel" name="ph1" placeholder="010"> -
                            <input class="form-control sel" name="ph2" placeholder="xxxx"> -
                            <input class="form-control sel" name="ph3" placeholder="xxxx">
                        ...
                        <p>${msg}</p>
                        <div class="form-group">
                            <input type="button" value="회원가입" class="btn btn-lg btn-success btn-block" onclick="check()" />
                        </div>
                        <div class="form-group">
